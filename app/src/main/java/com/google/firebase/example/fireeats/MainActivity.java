...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int LIMIT = 50; //Indicates the nº of restaurants retrieved
    ...
    private Query mQuery; //Used to save queries
    ...
    //Add random restaurants to the DB
    ...
    //What happens with the click in the menu items
    @Override
